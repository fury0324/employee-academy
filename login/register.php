                ...
                if ($stmt->execute()) {
                    ...
                    if ($admin_result && $admin_result->num_rows > 0) {
                        while ($admin = $admin_result->fetch_assoc()) {
                            ...
                            $notif_type = 'user_registration';
                            $notif_title = 'New User Registration';
                            $notif_message = "$firstname $lastname ($email) has registered and needs approval.";
                            $notif_link = 'admin_approval.php';
                    ...
                    try {
                        ...
                        $mail->Body = "
                            ...
                            <hr>
                            <p><strong>Approval Link:</strong> <a href='http://localhost/upstaff/admin/admin_approval.php'>Click here to approve</a></p>
                        ";
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select name="position" id="position" required
                            ...
                            <option value="Personal Assistant" <?php echo (isset($_POST['position']) && $_POST['position'] == "Personal Assistant") ? 'selected' : ''; ?>>Personal Assistant</option>
                            <option value="Executive Assistant" <?php echo (isset($_POST['position']) && $_POST['position'] == "Executive Assistant") ? 'selected' : ''; ?>>Executive Assistant</option>
                            <option value="E-commerce Virtual Assistant" <?php echo (isset($_POST['position']) && $_POST['position'] == "E-commerce Virtual Assistant") ? 'selected' : ''; ?>>E-commerce Virtual Assistant</option>
                            <option value="Virtual Assistant" <?php echo (isset($_POST['position']) && $_POST['position'] == "Virtual Assistant") ? 'selected' : ''; ?>>Virtual Assistant</option>
                            <option value="Concierge Virtual Assistant" <?php echo (isset($_POST['position']) && $_POST['position'] == "Concierge Virtual Assistant") ? 'selected' : ''; ?>>Concierge Virtual Assistant</option>
                            <option value="Accounts Virtual Assistant" <?php echo (isset($_POST['position']) && $_POST['position'] == "Accounts Virtual Assistant") ? 'selected' : ''; ?>>Accounts Virtual Assistant</option>
                            <option value="Data Entry Specialist" <?php echo (isset($_POST['position']) && $_POST['position'] == "Data Entry Specialist") ? 'selected' : ''; ?>>Data Entry Specialist</option>
                            <option value="Administrative Assistant" <?php echo (isset($_POST['position']) && $_POST['position'] == "Administrative Assistant") ? 'selected' : ''; ?>>Administrative Assistant</option>
                            <option value="Administrative Support" <?php echo (isset($_POST['position']) && $_POST['position'] == "Administrative Support") ? 'selected' : ''; ?>>Administrative Support</option>
                            <option value="Team Assistant" <?php echo (isset($_POST['position']) && $_POST['position'] == "Team Assistant") ? 'selected' : ''; ?>>Team Assistant</option>
                            <option value="Accountant" <?php echo (isset($_POST['position']) && $_POST['position'] == "Accountant") ? 'selected' : ''; ?>>Accountant</option>
                            <option value="Bookkeeper" <?php echo (isset($_POST['position']) && $_POST['position'] == "Bookkeeper") ? 'selected' : ''; ?>>Bookkeeper</option>
                            <option value="Accounts PayableSpecialist" <?php echo (isset($_POST['position']) && $_POST['position'] == "Accounts Receivable Specialist") ? 'selected' : ''; ?>>Accounts Receivable Specialist</option>
                            <option value="Accounts Payable Specialist" <?php echo (isset($_POST['position']) && $_POST['position'] == "Accounts Payable Specialist") ? 'selected' : ''; ?>>Accounts Payable Specialist</option>
                            <option value="Customer Support Representative" <?php echo (isset($_POST['position']) && $_POST['position'] == "Customer Support Representative") ? 'selected' : ''; ?>>Customer Support Representative</option>
                            <option value="Human Resources Manager" <?php echo (isset($_POST['position']) && $_POST['position'] == "Human Resources Manager") ? 'selected' : ''; ?>>Human Resources Manager</option>
                            <option value="Human Resources Assistant" <?php echo (isset($_POST['position']) && $_POST['position'] == "Human Resources Assistant") ? 'selected' : ''; ?>>Human Resources Assistant</option>
                            <option value="Recruitment Assistant" <?php echo (isset($_POST['position']) && $_POST['position'] == "Recruitment Assistant") ? 'selected' : ''; ?>>Recruitment Assistant</option>
                            <option value="Recruitment Officer" <?php echo (isset($_POST['position']) && $_POST['position'] == "Recruitment Officer") ? 'selected' : ''; ?>>Recruitment Officer</option>
                            <option value="Human Resources Associate" <?php echo (isset($_POST['position']) && $_POST['position'] == "Human Resources Associate") ? 'selected' : ''; ?>>Human Resources Associate</option>
                            <option value="Operations Manager" <?php echo (isset($_POST['position']) && $_POST['position'] == "Operations Manager") ? 'selected' : ''; ?>>Operations Manager</option>
                            <option value="Account Manager" <?php echo (isset($_POST['position']) && $_POST['position'] == "Account Manager") ? 'selected' : ''; ?>>Account Manager</option>
                            <option value="Learning and Development Specialist / Night Shift Manager" <?php echo (isset($_POST['position']) && $_POST['position'] == "Learning and Development Specialist / Night Shift Manager") ? 'selected' : ''; ?>>Learning and Development Specialist / Night Shift Manager</option>
                            <option value="Graphic Designer" <?php echo (isset($_POST['position']) && $_POST['position'] == "Graphic Designer") ? 'selected' : ''; ?>>Graphic Designer</option
                            <option value="Architectural Draftsperson" <?php echo (isset($_POST['position']) && $_POST['position'] == "Architectural Draftsperson") ? 'selected' : ''; ?>>Architectural Draftsperson</option>
                            <option value="Amazon Catalog and Listing Virtual Assistant" <?php echo (isset($_POST['position']) && $_POST['position'] == "Amazon Catalog and Listing Virtual Assistant") ? 'selected' : ''; ?>>Amazon Catalog and Listing Virtual Assistant</option>
                            <option value="Amazon Marketing Manager" <?php echo (isset($_POST['position']) && $_POST['position'] == "Amazon Marketing Manager") ? 'selected' : ''; ?>>Amazon Marketing Manager</option>
                            <option value="Real Estate Administrative Support" <?php echo (isset($_POST['position']) && $_POST['position'] == "Real Estate Administrative Support") ? 'selected' : ''; ?>>Real Estate Administrative Support</option>
                            <option value="Intake Caller" <?php echo (isset($_POST['position']) && $_POST['position'] == "Intake Caller") ? 'selected' : ''; ?>>Intake Caller</option>
                            <option value="Attorney" <?php echo (isset($_POST['position']) && $_POST['position'] == "Attorney") ? 'selected' : ''; ?>>Attorney</option>
                            <option value="Administrative Support Specialist" <?php echo (isset($_POST['position']) && $_POST['position'] == "Administrative Support Specialist") ? 'selected' : ''; ?>>Administrative Support Specialist</option>
                            <option value="Client Communication and Sales Coordinator" <?php echo (isset($_POST['position']) && $_POST['position'] == "Client Communication and Sales Coordinator") ? 'selected' : ''; ?>>Client Communication and Sales Coordinator</option>
                            <option value="Recoveries and Customer Care Specialist(German) " <?php echo (isset($_POST['position']) && $_POST['position'] == "Recoveries and Customer Care Specialist") ? 'selected' : ''; ?>>Recoveries and Customer Care Specialist (German) </option>
                        </select>
                    </div>
