...
<aside id="sidebar" class="fixed top-0 left-0 w-64 h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white flex flex-col shadow-2xl transition-all duration-300 z-50">
    ...
    <nav class="flex-1 py-6 px-3 space-y-1 overflow-y-auto">
        ...
        <!-- Courses - Updated with active state -->
        <a href="../admin/course_management.php" 
           class="nav-link flex items-center px-4 py-3 rounded-xl transition-all duration-200 group
                  <?php echo basename($_SERVER['PHP_SELF']) == 'course_management.php' ? 'active' : ''; ?>">
        ...
        <div class="relative">
            <button id="settingsBtn"
                    class="nav-link flex items-center justify-between w-full px-4 py-3 rounded-xl transition-all duration-200 group
                           <?php echo basename($_SERVER['PHP_SELF']) == 'audit_logs.php' ? 'active' : ''; ?>">
                <div class="flex items-center">
                ...
                <i id="settingsArrow" class="fas fa-chevron-down text-xs transition-transform duration-300 sidebar-text
                   <?php echo basename($_SERVER['PHP_SELF']) == 'audit_logs.php' ? 'rotate-180' : ''; ?>"></i>
            </button>
            <div id="settingsDropdown" class="mt-2 ml-8 space-y-0 <?php echo basename($_SERVER['PHP_SELF']) == 'audit_logs.php' ? '' : 'hidden'; ?>">
